...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosDetalhamentoConsulta> dadosDetalhamentoMedicoJson;
    ...
    @WithMockUser
    void consulta_cenario1() throws Exception  {
    ...
    @WithMockUser
    void consulta_cenario2() throws Exception  {
